...
//!   access;
//! - validation checks context-independent Chapter 9 field and topology rules.
//!
...
//! consumer declines to cache or interpret it.
//!
...
pub use configuration::{
    ...
    InterfaceDescriptor, InterfaceIter,
};
